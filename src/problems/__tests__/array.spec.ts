...
describe('array', () => {
  it.each(maxNumOfMarkedIndicesTestData)(
    'maxNumOfMarkedIndices',
    ({ input, expected }) => {
  ...
  it.each(maxDistToClosestTestData)(
    'maxDistToClosest',
    ({ input, expected }) => {
  ...
  it.each(removeDuplicatesTestData)(
    'removeDuplicates',
    ({ input, expected: { k, nums } }) => {
  ...
  it.each(mergeTestData)(
    'should test merge function',
  ...
  it.each([
    ...
    'returns the closest sum for %p and target %p',
  ...
  it.each([
    ...
    'returns correct value for nums1 %p and nums2 %p',
