...
describe('other', () => {
  ...
  it.each(getMinBoatsTestData)(
    'getMinBoats',
    ({ input: { arr, limit }, expected }) => {
      expect(getMinBoats(arr, limit)).toBe(expected);
    }
  );

  it.each(countSubArrTestData)(
    'countSubArr',
  ...
  it.each(getMaxRopePointsTestData)(
    'getMaxRopePoints',
    ({ input: { arr, rope }, expected }) => {
  ...
  it.each(getMaxSumOfSubArrTestData)(
    'getMaxSumOfSubArr',
    ({ input, expected }) => {
  ...
  it.each(getMaxKTestData)(
    'getMaxK',
    ({ input: { arr1, arr2, k }, expected }) => {
  ...
  it.each(getNthUglyNumberTestData)(
    'getNthUglyNumber',
    ({ input, expected }) => {
  ...
  it.each(countLostNumbersTestData)(
    'countLostNumbers',
    ({ input: { arr, range }, expected }) => {
      expect(countLostNumbers(arr, range)).toBe(expected);
    }
  );

  it.each(getConnectedRegionsTestData)(
    'getConnectedRegions',
    ({ input, expected }) => {
  ...
  it.each(getAllTwoTuplesTestData)(
    'getAllTwoTuples',
    ({ input: { arr, target }, expected }) => {
  ...
  it.each(getMinMissingNumberTestData)(
    'getMinMissingNumber',
    ({ input, expected }) => {
  ...
  it.each(findKthLargestTestData)(
    'findKthLargest',
    ({ input: { arr, k }, expected }) => {
  ...
  it.each(getMinPalindromeTestData)(
    'getMinPalindrome',
    ({ input, expected }) => {
  ...
  it.each(getMaxIncreasingNumTestData)(
    'getMaxIncreasingNum',
    ({ input, expected }) => {
  ...
  it.each(getClosestSumKTestData)(
    'getClosestSumK',
    ({ input: { arr, k }, expected }) => {
  ...
  it.each(findWordsTestData)(
    'findWords',
    ({ input: { board, words }, expected }) => {
  ...
  it.each(countSubsequenceTestData)(
    'countSubsequence',
    ({ input: { s, t }, expected }) => {
  ...
  it.each(existWordTestData)(
    'existWord',
    ({ input: { board, word }, expected }) => {
      expect(existWord(board, word)).toBe(expected);
    }
  );

  it.each(countJointMethodsTestData)(
    'countJointMethods',
    ({ input: { str, arr }, expected }) => {
  ...
  it.each(getValidParenthesesTestData)(
    'getValidParentheses',
    ({ input, expected }) => {
  ...
  it.each(getMaxSizeOfAllOnesTestData)(
    'getMaxSizeOfAllOnes',
    ({ input, expected }) => {
  ...
  it.each(longestValidParenthesesTestData)(
    'longestValidParentheses',
    ({ input, expected }) => {
  ...
  it.each(findSubstringTestData)(
    'findSubstring',
    ({ input: { s, words }, expected }) => {
  ...
  it.each(distinctSubsequenceIITestData)(
    'distinctSubsequenceII',
    ({ input, expected }) => {
  ...
  it.each(majorityElement2TestData)(
    'majorityElement2',
    ({ input, expected }) => {
  ...
  it.each(mergeStonesTestData)(
    'mergeStones',
    ({ input: { stones, k }, expected }) => {
      expect(mergeStones(stones, k)).toBe(expected);
    }
  );

  it.each(minWindowTestData)(
    'minWindow',
    ({ input: { str1, str2 }, expected }) => {
      expect(minWindow(str1, str2)).toBe(expected);
    }
  );

  it.each(setZerosTestData)('setZeros', ({ input, expected }) => {
    const clone = (input: number[][]) =>
      input.slice().map((val) => val.slice());
  ...
  test('getSumOfi1j1i2j2 will throw error if the provided index is invalid', () => {
    expect(() => getSumOfi1j1i2j2([[]], 0, 0, 1, 1)).toThrowError(
      'Invalid index'
    );
  });
  ...
  it.each(getMaxArrOf2PartsMinTestData)(
    'getMaxArrOf2PartsMin',
    ({ input, expected }) => {
  ...
  it.each(lengthOfLongestSubstringTestData)(
    'lengthOfLongestSubstring',
    ({ input, expected }) => {
  ...
  it.each(getMaxPartsArrayTestData)(
    'getMaxPartsArray',
    ({ input, expected }) => {
  ...
  it.each(getSubsequenceWithBiggestDictionarySequenceTestData)(
    'getSubsequenceWithBiggestDictionarySequence',
    ({ input: { str, k }, expected }) => {
      expect(getSubsequenceWithBiggestDictionarySequence(str, k)).toBe(
        expected
      );
    }
  );
  ...
  it.each(minEatingSpeedTestData)(
    'minEatingSpeed',
    ({ input: { arr, h }, expected }) => {
  ...
  it.each(maxRunTimeTestData)(
    'maxRunTime',
    ({ input: { arr, n }, expected }) => {
      expect(maxRunTime(n, arr)).toBe(expected);
    }
  );

  it.each(leastWaitingTimeTestData)(
    'leastWaitingTime',
    ({ input: { arr, n }, expected }) => {
  ...
  it.each(numTilePossibilitiesTestData)(
    'numTilePossibilities',
    ({ input, expected }) => {
  ...
  it.each(numSubMatrixSumTargetTestData)(
    'numSubMatrixSumTarget',
    ({ input: { matrix, target }, expected }) => {
      expect(numSubMatrixSumTarget(matrix, target)).toBe(expected);
    }
  );

  it.each(maxEqualRowsAfterFlipsTestData)(
    'maxEqualRowsAfterFlips',
    ({ input, expected }) => {
  ...
  it.each(maxSquareSideLengthTestData)(
    'maxSquareSideLength',
    ({ input, expected }) => {
  ...
  it.each(countSubArraysTestData)(
    'countSubArrays',
    ({ input: { arr, num }, expected }) => {
  ...
  it.each(getNumOfMostRightOneTestData)(
    'getNumOfMostRightOne',
    ({ input, expected }) => {
  ...
  it.each(getMinTimeOfDrawingTestData)(
    'getMinTimeOfDrawing',
    ({ input: { arr, num }, expected }) => {
  ...
  it.each(divideTestData)(
    'divide',
    ({ input: { dividend, divisor }, expected }) => {
      expect(divide(dividend, divisor)).toBe(expected);
    }
  );

  it.each(wildcardMatchTestData)(
    'wildcardMatch',
    ({ input: { s, p }, expected }) => {
  ...
  it.each(combinationSumTestData)(
    'combinationSum',
    ({ input: { arr, target }, expected }) => {
  ...
  it.each(longestIncreasingPathTestData)(
    'longestIncreasingPath',
    ({ input, expected }) => {
  ...
  it.each(ladderLengthTestData)(
    'ladderLength',
    ({ input: { beginWord, endWord, wordList }, expected }) => {
      expect(ladderLength(beginWord, endWord, wordList.slice())).toBe(expected);
      expect(ladderLength2(beginWord, endWord, wordList.slice())).toBe(
        expected
      );
    }
  );

  it.each(longestConsecutiveTestData)(
    'longestConsecutive',
    ({ input, expected }) => {
  ...
  it.each(partitionPalindromeTestData)(
    'partitionPalindrome',
    ({ input, expected }) => {
  ...
  it.each(canCompleteCircuitTestData)(
    'canCompleteCircuit',
    ({ input: { gas, cost }, expected }) => {
  ...
  it.each(wordBreakTestData)(
    'wordBreak',
    ({ input: { s, wordDict }, expected }) => {
      expect(wordBreak(s, wordDict)).toBe(expected);
    }
  );

  it.each(findOrderTestData)(
    'findOrder',
    ({ input: { numCourses, prerequisites }, expected }) => {
  ...
  it.each(increasingTripletTestData)(
    'increasingTriplet',
    ({ input, expected }) => {
  ...
  it.each(fourSumCountTestData)(
    'fourSumCount',
    ({ input: { nums1, nums2, nums3, nums4 }, expected }) => {
      expect(fourSumCount(nums1, nums2, nums3, nums4)).toBe(expected);
    }
  );

  it.each(topKFrequentTestData)(
    'topKFrequent',
    ({ input: { nums, k }, expected }) => {
      expect(topKFrequent(nums, k)).toEqual(expected);
    }
  );

  it.each(longestSubstringTestData)(
    'longestSubstring',
    ({ input: { s, k }, expected }) => {
  ...
  it.each(combinationSum2TestData)(
    'combinationSum2',
    ({ input: { arr, target }, expected }) => {
      ...
      expect(combinationSum2(arr, target).sort(sorter)).toEqual(
        expected.sort(sorter)
      );
      expect(combinationSum3(arr, target).sort(sorter)).toEqual(
        expected.sort(sorter)
      );
    }
  );

  it.each(uniquePathsWithObstaclesTestData)(
    'uniquePathsWithObstacles',
    ({ input, expected }) => {
  ...
  it.each(nextGreaterElementsTestData)(
    'nextGreaterElements',
    ({ input, expected }) => {
  ...
  it.each(restoreIpAddressesTestData)(
    'restoreIpAddresses',
    ({ input, expected }) => {
  ...
  it.each(multiplyTestData)(
    'multiply',
    ({ input: { num1, num2 }, expected }) => {
  ...
  it.each(getMinOutNumberOfPeopleTestData)(
    'getMinOutNumberOfPeople',
    ({ input, expected }) => {
