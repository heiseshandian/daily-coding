...
export function isSingleLinkedListEqual(
  ...
  return isEqual(
    head1,
    head2,
    (node1: SingleLinkedList, node2: SingleLinkedList) =>
      node1.val === node2.val
  );
}

export function isSpecialNodeEqual(
  head1: SpecialNode | null,
  head2: SpecialNode | null
) {
