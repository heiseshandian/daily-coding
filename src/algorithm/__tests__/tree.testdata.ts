export const preVisitNodeTestData = [
    ...
    { input: [1, 2, null, null, 3, 4, 6, null, null, null, 5, null, null], expected: [1, 2, 3, 4, 6, 5] },
];
...
export const postVisitNodeTestData = [
    ...
    { input: [1, 2, null, null, 3, 4, 6, null, null, null, 5, null, null], expected: [2, 6, 4, 5, 3, 1] },
];
...
export const middleVisitNodeTestData = [
    ...
    { input: [1, 2, null, null, 3, 4, 6, null, null, null, 5, null, null], expected: [2, 1, 6, 4, 3, 5] },
];
...
export const visitTreeByLevelTestData = [
    ...
    { input: [1, null, null], expected: [1] },
    { input: [1, 2, null, null, 3, null, null], expected: [1, 2, 3] },
    { input: [1, 2, null, null, 3, 4, 6, null, null, null, 5, null, null], expected: [1, 2, 3, 4, 5, 6] },
];
...
export const getMaxWidthTestData = [
    ...
    { input: [1, 2, null, null, 3, 4, 6, null, null, null, 5, null, null], expected: 2 },
    {
        input: [
            1,
            2,
