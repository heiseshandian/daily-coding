...
export const prefixTestData = [
    { input: ['abc', 'ab', 'test', 'hello', 'world'], prefixWord: 'a', expected: 2 },
    { input: ['abc', 'ab', 'test', 'hello', 'world'], prefixWord: 't', expected: 1 },
    { input: [], prefixWord: 't', expected: 0 },
    { input: ['hell'], prefixWord: 'e', expected: 0 },
    { input: ['abc', 'ab', 'test', 'hello', 'world'], prefixWord: 'abcd', expected: 0 },
];
