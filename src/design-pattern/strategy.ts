...
export function calculateBonus(bonusLevel: BonusLevel, baseSalary: number): number {
    // 算法使用
...
const Tween: Record<
    AnimationType,
    (elapsedTime: number, sourcePosition: number, destPosition: number, totalTime: number) => number
> = {
